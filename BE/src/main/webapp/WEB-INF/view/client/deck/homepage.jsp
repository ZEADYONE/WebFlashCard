    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <main>
                ...
                <!-- BACK -->
                <a href="/client/library"><i class="fa-solid fa-arrow-left exit"></i></a>
                ...
                <section class="title-section">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="<c:url value='/client/card/create/${deck.id}'/>" style=" pointer-events: none;">
                                <button class="btn add" style="visibility: hidden;" disabled>Add card</button>
                            </a>
                        </c:otherwise>
                    </c:choose>
                ...
                <section class="flashcards-container">
                    ...
                    <c:if test="${totalPages > 1}">
                        <c:url value="/client/deck/${deck.id}" var="baseUrl">
